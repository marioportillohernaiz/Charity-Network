...
#         title_meta = soup.find("meta", {"property": "og:site_name"})
#         title = title_meta["content"] if title_meta else (soup.title.string if soup.title else "")

#         description = soup.find("meta", {"name": "description"})
#         description = description["content"] if description else ""

#         address = soup.find("p", class_="address") or soup.find("span", class_="address") or soup.find("div", class_="address")
